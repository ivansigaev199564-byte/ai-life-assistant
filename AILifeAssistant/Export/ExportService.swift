...
///
/// И не на главном акторе: кодирование идёт на фоне, а передача туда
/// изолированной функции теряет актор, о чём компилятор предупреждает
/// и что в шестом Swift станет ошибкой.
